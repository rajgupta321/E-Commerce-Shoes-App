          ...
          child: Column(
            children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: FadeInUp(duration: Duration(milliseconds: 1000),
                        child: Container(
                          ...
                          child: Center(
                            child: Text("Loafers", style: TextStyle(fontSize: 17),),
                          ),
                        ),
                      ),
                    ),
              ...
              FadeInUp(duration: Duration(milliseconds: 1500),
                  child: makeItem(image: 'assets/images/Formal_Leathers.jpg',
                      tag: 'red', context: context,category: 'Formal')  ),
              FadeInUp(duration: Duration(milliseconds: 1600),
                  child: makeItem(image: 'assets/images/Loafer.jpeg',
                      tag: 'blue', context: context,category: 'Casual')),
              FadeInUp(duration: Duration(milliseconds: 1700),
                  child: makeItem(image: 'assets/images/Canvas_Loafar.jpeg',
                    tag: 'white', context: context,category: 'Canvas',)),
              FadeInUp(duration: Duration(milliseconds: 1700),
                  child: makeItem(image: 'assets/images/Venus_Loafer.jpg',
                    tag: 'white', context: context,category: 'Venus',)),
            ],
          ),
        ),
      ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text("100\$", style: TextStyle(color: Colors.indigoAccent, fontSize: 40, fontWeight: FontWeight.bold),),
            ],
          ),
        ),
      ),
